...
import singapore.webapp.WebUiResources;
import singapore.dbsetup.HibernateSetup;
import singapore.filter.NoDataFilter;
import singapore.ioc.WebApplicationServerModule;
...
/**
 * Configuration point for Singapore Airport Asset Management Web Application.
 * 
 * @author Generated
 * 
 */
        ...
        try {
            ...
            getDefaultHost().attach(
                    new WebUiResources(
                            ...
                            injector,
                            "Singapore Airport Asset Management",
                            "An application server for Singapore Airport Asset Management",
                            "Singapore Asset Management Pty. Ltd.",
                            "Authors",
                            webApp
                            ));
