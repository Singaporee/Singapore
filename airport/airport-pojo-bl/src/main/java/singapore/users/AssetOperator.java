...
public class AssetOperator extends AbstractPersistentEntity<Asset> {
    ...
    @Override
    @Observable
    public AssetOperator setKey(final Asset key) {
        this.key = key;
        return this;
    }
    ...
    @AfterChange(AssetOperatorExclusivityDefiner.class)
    private Role role;
    
    @Observable
    public AssetOperator setRole(final Role role) {
        this.role = role;
        return this;
    }
    ...
    @Observable
    public AssetOperator setBu(final BusinessUnit bu) {
        this.bu = bu;
        return this;
    }
    ...
    @Observable
    public AssetOperator setOrg(final Organisation org) {
        this.org = org;
        return this;
    }
    ...
    @Observable
    public AssetOperator setStartDate(final Date startDate) {
